...
namespace NumberSorter.Domain.ViewModels
{
    public class VisualizationTypeViewModel : ReactiveObject
    {
        ...
        public VisualizationTypeViewModel()
        {
            ...
            sortTypes.Add(new VisualizationTypeLineViewModel(VisualizationType.ScaledColumnVisualizer, "Scaled columns visualizer"));
            sortTypes.Add(new VisualizationTypeLineViewModel(VisualizationType.ScaledColumnNoSpacerVisualizer, "Scaled columns visualizer (No spacer)"));

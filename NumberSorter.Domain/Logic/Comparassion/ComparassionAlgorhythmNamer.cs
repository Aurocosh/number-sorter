...
namespace NumberSorter.Domain.Logic
{
    public static class ComparassionAlgorhythmNamer
    {
        ...
        static ComparassionAlgorhythmNamer()
        {
            ...
            _nameDictionary.Add(ComparassionAlgorhythmType.SwapWindowMergeSort, "Swap window merge sort");
            ...
            _nameDictionary.Add(ComparassionAlgorhythmType.RotationMergeSort, "Rotation merge sort");
            _nameDictionary.Add(ComparassionAlgorhythmType.BufferRotationMergeSort, "Buffer rotation merge sort");
            ...
            _nameDictionary.Add(ComparassionAlgorhythmType.SwapWindowBottomUpMergeSort, "Swap window merge sort (Bottom up)");
            ...
            _nameDictionary.Add(ComparassionAlgorhythmType.RotationBottomUpMergeSort, "Rotation merge sort (Bottom up)");
            _nameDictionary.Add(ComparassionAlgorhythmType.BufferRotationBottomUpMergeSort, "Buffer rotation merge sort (Bottom up)");

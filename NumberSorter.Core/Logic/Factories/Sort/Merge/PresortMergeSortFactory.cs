...
{
    public class PresortMergeSortFactory : GenericSortFactory
    {
        private ISortFactory SmallRunSortFactory { get; }
        private ILocalMergeFactory LocalMergeFactory { get; }

        public PresortMergeSortFactory(ISortFactory smallRunSortFactory, ILocalMergeFactory localMergeFactory)
        {
        ...
        {
            return new PresortMergeSort<T>(comparer, SmallRunSortFactory, LocalMergeFactory);
        }
    }
}

...
{
    public class StrandFixedBufferSortFactory : GenericSortFactory
    {
        private ILocalMergeFactory LocalMergeFactory { get; }

        public StrandFixedBufferSortFactory(ILocalMergeFactory localMergeFactory)
        {
        ...
        {
            return new StrandFixedBufferSort<T>(comparer, LocalMergeFactory);
        }
    }
}

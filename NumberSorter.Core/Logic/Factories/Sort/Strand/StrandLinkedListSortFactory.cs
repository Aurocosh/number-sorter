...
{
    public class StrandLinkedListSortFactory : GenericSortFactory
    {
        private ILocalMergeFactory LocalMergeFactory { get; }

        public StrandLinkedListSortFactory(ILocalMergeFactory localMergeFactory)
        {
        ...
        {
            return new LinkedListStrandSort<T>(comparer, LocalMergeFactory);
        }
    }
}

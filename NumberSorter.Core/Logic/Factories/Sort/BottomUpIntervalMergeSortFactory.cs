...
{
    public class BottomUpIntervalMergeSortFactory : GenericSortFactory, ILocalMergeFactory
    {
        private IPositionLocatorFactory PositionLocatorFactory { get; }

        public BottomUpIntervalMergeSortFactory(IPositionLocatorFactory positionLocatorFactory)
        {
        ...
        {
            return new BottomUpIntervalMergeSort<T>(comparer, PositionLocatorFactory);
        }

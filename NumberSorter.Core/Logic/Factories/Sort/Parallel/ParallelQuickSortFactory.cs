...
{
    public class ParallelQuickSortFactory : GenericSortFactory
    {
        ...
        public ParallelQuickSortFactory(int cutoffSize, ISortFactory cutoffSortFactory, IPivotSelectorFactory pivotSelectorFactory)
        {
        ...
        {
            return new ParallelQuickSort<T>(comparer, PivotSelectorFactory, CutoffSortFactory, CutoffValue);
        }
    }
}
